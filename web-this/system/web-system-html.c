...
void WebSystemHtml()
{
	...
	HttpAddText("See NIST Cryptographic Standards and Guidelines examples - https://csrc.nist.gov/projects/cryptographic-standards-and-guidelines/example-values");
	
    WebAddH2("Block cipher CBC-AES128 (Decryption) test");
    ...
    */
    ...
    WebAddH2("Secure hashing SHA-256 2 block test");
    uint8_t hash[32];
    ...
    WebAddH2("Secure hashing SHA1 2 block test");
	//Expect 84983E44 1C3BD26E BAAE4AA1 F95129E5
	//       E54670F1
    ...
    WebAddH2("Big number parse");
    uint32_t bn1 [32];
	char* bn1text = 
"0";
    
    BnParseHex1024(bn1,  bn1text);
    HttpAddText("<code>");
    BnAsHttp1024(bn1);
    HttpAddText("</code>");
	
    WebAddH2("Big number increment");
	BnInc1024(bn1);
    HttpAddText("<code>");
    BnAsHttp1024(bn1);
    HttpAddText("</code>");
	
    WebAddH2("Big number addition");
    uint32_t bn2 [32];
	char*bn2text = 
...
"B7F18EA27637B07957D32F2BDE8706227D04665EC91BAF8B1AC3EC9144AB7F21";
    ...
    */
    /*
    WebAddH2("Fast RSA test");
    static int rsaTicket = 0;
    static bool rsaStarted = false;
    if (!rsaStarted)
    {
